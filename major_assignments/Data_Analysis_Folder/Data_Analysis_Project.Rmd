...
```{r}
ev_raw <- read.csv("data/EV_RAW_DATA.csv") 
...
We refined our questions to focus more on precinct level data instead of overall state data. We are going to look more closely at precincts that have interesting and unusual patterns and why this might be. 
