...
**A4**Charleston is the capital of West Virginia so probably has a larger population than a lot of these other cities. Also, since the state government is primary located in this capital city, its population may be more politically aware and active. 
...
**A5** The Trump National Committee JFC, Inc. It received 14063 donations and $463,944.40
...
**A7**I noticed that the largest average for campaign contributions was for Guthrie for Congress at $3,300. Even though the Trump campaign got the most contributions and money total, its average contribution was a lot smaller. It could be interesting to look at why these the Guthrie campaign and others draw in larger contributions on average. There are also big gaps between the maximum amounts of contribution. The Trump National Committee JFC had a $10,000 maximum contribution and and everything else was a lot less. The refund of earmarked contribution was also something that jumped out. I am curious why so many contributions were refunded and think that is something I would want to explore and possibly include in a news story. 
