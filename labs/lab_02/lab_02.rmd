...
**A3** 
July saw the largest number of registrations. This helps us see that Trump's shooting and Biden dropping out likely had some role in pushing people to register to vote. 
```{r}
md_voters_2024 <- md_voters_2024 |>
