...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** Precinct ID, precinct name, district numbers, polling ID, shape length and shape area and shape. 
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** Precinct ID, precinct name, district numbers, polling ID, shape length and shape area and shape. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** I see a map that shows precincts in Prince George's County. Most are gray. Some are white (ghost precincts) It is on a grid with latitude and longitude.
...
**Task** Run the following code. Describe the output in the space below. **Answer** Now I have tigris.
...
**Task** Run the following code. Describe the output in the space below. **Answer** Now I have information  about  counties.
...
**Task** Run the following code. Describe the output in the space below. **Answer** THis gives me just the Maryland counties. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This gives me a map of counties in Maryland. 
...
### Task: Run code
### What I want on top and more visible should be going last. Base layer goes first. 

**Task** Run the following code. Describe the output in the space below. **Answer** I see the county boundary with the precinct boundaries on top. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** I see voting turnout data aggregated by precinct. I created a new datframe to do this. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This joins the dataframe I just created with my precinct dataframe
...
**Task** Run the following code. Describe the output in the space below. **Answer** I see the voter turnout data by precinct on the map by total eligible voters. The map actually has a theme and is designed and has a color scale. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This shows me total eligible voters by county and party.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This gives me maryland county population data. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This involves the geography with the maryland population data I was just using. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This is my md county population dataframe and my voters by county dataframe.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This renames counties and the county column label. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This joins the maryland county population dataframe and the voters by county dataframe and creates a new dataframe.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This calculates the number of voters per 10,000 population for each ocunty and sorts them. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This creates a map based on the dataframe I created. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This changes the color scheme of the map I just created. 
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** This changes the map coloring to a log scale. I notice that the counties with more votes are on the eastern area of the state and that there is one county in southern Maryland that has the fewest votes per 10k.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This does the calcualtion for unaffiliated voters.
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see, especially on the ends of the scale? **Answer** This creates a map for unaffiliated voters. I notice that there are more unaffiliated voters in the middle of the state and less unaffiliated voters in Western Maryland and a few other counties and Baltimore City. The areas with less unaffiliated voters are not clustered together while the areas with more unaffiliated voters are. 
```{r}
ggplot() +
