...
**Task** In the console (look below), type 2+2 and hit enter. What does it return? Type your answer below. **Answer:** It returns "[1] 4"
...
**Answer** It has 131,395 observations and 24 variables. 
...
**Answer** This code is telling us how many contributions were donated each date. It groups by date and then counts the number of contributions for each date. The results from head only told us information about 6 individual contributions. This aggregates and tells us about all contributions but gives us a smaller amount of information about each of them. 
...
**Answer** This has arranged the results by date in descending order. We are able to see which dates the most donations came in on. 
...
**Answer** It groups the data by multiple things. We now see the amount of contribution and the count of them and what campaign they're for.
...
**Answer** This shows us the number of donations to each campaign and the amount. It arranges the number in descending order by total amount.
...
**Answer** This shows us how many donations and how much money each campaign/committee got and also gives us other descriptive statistics. Trump is the top result from Maryland.
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **Answer** This found descriptive statistics of donations from different cities in Maryland. It also arranges in descending order by total amount. 
