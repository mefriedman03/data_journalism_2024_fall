...
```{r echo=FALSE}
#census_api_key("69af58f24b417774ca4b439c4825255c357da8a0", install=TRUE)
```
...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer** Nevada had the largest percentage change and growth from 2000 to 2010 with a percentage change of more than 35%. 
...
Is the difference between Calvert and Montgomery significant? **Answer** We don't know because their margins of error overlap.
...
**Answer** It looks like only 21202 has an estimated household income of less than $50,000.
```{r}
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer** I am wondering where these zip codes are located and what similarities they have. I also have questions about the margin of error and how this impacts our ability to draw any real conclusions. I also wonder about patterns with high median incomes and high total amounts of contributions. 
