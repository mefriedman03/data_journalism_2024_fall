...
https://datawrapper.dwcdn.net/aXKPA/1/
...
md_gov_county <- md_gov_county |>
  mutate(Total = Cox + Moore + Lashar + Harding + Wallace + `Write-ins`) |>
...
I see a map zoomed into Maryland.
...
It is a lot easier to see what percentage of the vote Moore added in each county. 
...
https://datawrapper.dwcdn.net/Ct6v6/1/
