...
**Answer** It creates a new column in the original dataframe with the difference between unaffiliated voters in 2024 and 2022. Then it creates a new dataframe that arranges the counties in descending order based on the difference in unaffiliated voters.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I got a blank canvas.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see an actual plot that shows the difference in the number of unaffiliated voters by county. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** Now the chart is ordered from the county with the smallest difference in unaffiliated voters to the county with the largest difference in unaffiliated voters.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It is now a horizontal bar chart which makes it much easier to read the names of the counties.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It removes the gray background from the chart. 
...
**Task** Run the following code. **Answer** I ran this code. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** I see a blue background. It adjusts the theme of the chart.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** This changes the axis labels and adds a title and a srouce. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a dataframe that shows the total number of contributions by date. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a linechart that shows the dataframe I just created.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** This adds more specific dates instead of months. It allows us to see more detail. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** This formats it so the dates are easier to read. 
